...
class S3WriterAsync(S3StorageWriter):
    """
    Async-enabled implementation of S3StorageWriter using file IO.
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not self.single_file_per_rank:
            raise NotImplementedError(
                'single_file_per_rank flag not supported for S3StorageWriter'
            )
